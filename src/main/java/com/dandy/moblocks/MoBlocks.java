package com.dandy.moblocks;

import com.dandy.moblocks.block.ModBlocks;
import com.dandy.moblocks.item.ModItems;
...
public class MoBlocks
{
    ...
    public static final String MOD_ID = "moblocks";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public MoBlocks(FMLJavaModLoadingContext context)
    {
